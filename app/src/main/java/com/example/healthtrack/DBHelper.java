...
//    @SuppressLint("Range")
//    public PatientData getPatientDataById(String pId) {
...
//    public boolean deletePatientData(String pId) {
//        SQLiteDatabase db = this.getWritableDatabase();
...
//                @SuppressLint("Range") String pId = cursor.getString(cursor.getColumnIndex(COLUMN_PATIENT_ID));
